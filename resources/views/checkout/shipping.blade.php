        ...
        <form class="contact-form checkout-form" method="POST" action="{{ route('checkout.shipping.store') }}" data-checkout-shipping>
          ...
          <div class="form-row">
            <div class="form-group">
              ...
              <input class="form-field @error('first_name') has-error @enderror" id="first_name" name="first_name" type="text"
                     value="{{ old('first_name', $saved['first_name'] ?? '') }}" required>
              @error('first_name')<p class="form-error">{{ $message }}</p>@enderror
            </div>
            <div class="form-group">
              <label class="form-label" for="last_name">Last Name</label>
              <input class="form-field @error('last_name') has-error @enderror" id="last_name" name="last_name" type="text"
          ...
          <div class="form-row">
            <div class="form-group">
              ...
              <input class="form-field @error('email') has-error @enderror" id="email" name="email" type="email"
                     value="{{ old('email', $saved['email'] ?? '') }}" required>
              @error('email')<p class="form-error">{{ $message }}</p>@enderror
            </div>
            <div class="form-group">
              <label class="form-label" for="phone">Mobile Number</label>
              <input class="form-field @error('phone') has-error @enderror" id="phone" name="phone" type="tel"
          ...
          <div class="form-row">
            <div class="form-group">
              ...
              <select class="form-field @error('zone_id') has-error @enderror" id="zone_id" name="zone_id" required data-shipping-zone>
            ...
            <div class="form-group">
              ...
              <select class="form-field @error('city_id') has-error @enderror" id="city_id" name="city_id" required data-shipping-city>
          ...
          <div class="form-group">
            ...
            <input class="form-field @error('address_line1') has-error @enderror" id="address_line1" name="address_line1" type="text"
          ...
          <div class="form-row">
            <div class="form-group">
              ...
              <input class="form-field @error('district') has-error @enderror" id="district" name="district" type="text"
